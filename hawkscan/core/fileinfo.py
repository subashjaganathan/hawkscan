...
_MAGIC_SIGNATURES: list[tuple[int, bytes, str, str]] = [
    ...
    (0, b"\xd4\xc3\xb2\xa1", "pcap", "PCAP network capture (LE)"),
    (0, b"\xa1\xb2\xc3\xd4", "pcap", "PCAP network capture (BE)"),
    (0, b"\x4d\x3c\xb2\xa1", "pcap", "PCAP network capture (nanosecond)"),
    (0, b"\x0a\x0d\x0d\x0a", "pcapng", "PCAPNG network capture"),
